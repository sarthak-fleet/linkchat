      ...
      <div className="w-full max-w-sm rounded-2xl border border-white/20 bg-white/5 p-8 shadow-xl backdrop-blur-xl">
        ...
        <div className="space-y-3">
          ...
          >
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-white/20 bg-white/5 px-4 py-3 text-sm font-medium text-white backdrop-blur-xl transition hover:bg-white/10"
            >
